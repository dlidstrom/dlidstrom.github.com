...
- [Gibberish](#gibberish)
  - [Gibberish Section 1](#gibberish-section-1)
...
let private witnessLoop n r d a =
    let m = n - 1I
    let firstModPow = bigint.ModPow(a, d, n)
